...
const EQUIPES = [
  ...
  { id: 'amarelo', nome: 'Equipe Amarelo', lideres: 'Gustavo Massay e Taiwa', membros: ['Hugo Lacroix','Lorena','Ludmyla','Maria Clara','Matheus Almeida'], offset: 1, cor: '#FCD34D', grad: 'linear-gradient(135deg,#78350F,#F59E0B)', emoji: '🟡' },
