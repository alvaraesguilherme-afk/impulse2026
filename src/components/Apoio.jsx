...
const EQUIPES = [
  { id: 'verde', nome: 'Equipe Verde', lideres: 'Jhony e Linda', membros: ['Emanuel','Hellen Borges','Joel Marcos','Jerônimo','Lívia Andréa','Maria Clara'], offset: 0, cor: 'var(--accent-light)', grad: 'linear-gradient(135deg,#4C1D95,#7C3AED)', emoji: '🟢' },
  { id: 'amarelo', nome: 'Equipe Amarelo', lideres: 'Gustavo Massay e Taiwa', membros: ['Hugo Lacroix','Isabely Matos','Lorena','Ludmyla','Matheus Almeida'], offset: 1, cor: '#FCD34D', grad: 'linear-gradient(135deg,#78350F,#F59E0B)', emoji: '🟡' },
