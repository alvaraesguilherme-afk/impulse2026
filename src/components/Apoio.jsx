...
const EQUIPES = [
  ...
  { id: 'azul', nome: 'Equipe Azul', lideres: 'Walterley e Maria Júlia', membros: ['Mariana Gabrielle','Maurício','Rafael Chaves','Ryan Guedes','Stephany'], offset: 2, cor: '#60A5FA', grad: 'linear-gradient(135deg,#0C4A6E,#0EA5E9)', emoji: '♠' },
  { id: 'vermelho', nome: 'Equipe Vermelho', lideres: 'Francisco e Clara Cunha', membros: ['Gabriel Gomes','Gabriel Mendes','Lívia Andréa','Nicoly','Rennan'], offset: 3, cor: '#F87171', grad: 'linear-gradient(135deg,#7F1D1D,#EF4444)', emoji: '♥' },
]
